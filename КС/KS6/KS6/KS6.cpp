...
int main()
{
	...
	bitset<8> byte1, byte2, byte3, byte4; // Для октетов адреса подсети и хоста
	...
	cout << "Network ID: " << byte1.to_ulong() << "." << byte2.to_ulong() << ".0.0" << endl;
	cout << "Host ID: 0.0." << byte3.to_ulong() << "." << byte4.to_ulong() << endl;
